...
Two datasets are used in this project. One dataset deals with cross-sectional MRI data for adults aged between 18 to 96. The other dataset deals with longitudinal MRI data for older adults between 60 to 96. After data cleansing, we append the two datasets and obtain 608 valid observations in total.
...
We dropped `Hand` from our analysis since all the subjects are right-handed.
