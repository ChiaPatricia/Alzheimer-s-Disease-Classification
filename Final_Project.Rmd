...
We also notice that the estimated total intracranial volume (eTIV) differ between demantia and non-demantia group. People with demantia tend to have a lower eTIV value.
